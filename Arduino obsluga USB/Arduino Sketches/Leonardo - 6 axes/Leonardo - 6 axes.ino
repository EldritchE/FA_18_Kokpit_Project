...
byte rowPins[NUMROWS] = {9,8,7,6,5}; 
byte colPins[NUMCOLS] = {4,3,2,1,0}; 
...
void loop() { 
 ...
 // read the input on analog pin 0:
  ...
  int RxValue = analogRead(A3);
  int RyValue = analogRead(A4);
  int RzValue = analogRead(A5);
...
int button25State = !digitalRead(10);
if (button25State == 1)
{
...
int button26State = !digitalRead(11);
if (button26State == 1)
{
...
int button27State = !digitalRead(12);
if (button27State == 1)
{
